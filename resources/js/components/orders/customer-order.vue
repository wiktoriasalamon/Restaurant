    ...
    <v-stepper class="background" v-model="e1">
        ...
        <v-stepper-items>
                ...
                <v-card>
                    ...
                    <v-card-text>
                        <v-form>
                            ...
                            ></v-text-field>
                            <v-text-field :rules="[rules.required]" label="Ulica"
            ...
            <v-stepper-content class="background" step="3">
                ...
                <v-btn @click="completeOrderOnline" color="secondary" v-bind:loading="loadingButton">Zamów</v-btn>
